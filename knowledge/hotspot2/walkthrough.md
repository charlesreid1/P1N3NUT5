...
ANQP_QUERY = bytes([
    ...
    0x01,           # Dialog Token
    # Advertisement Protocol IE: id=108, len=2, tuple=(0x7f, 0x00)
    0x6c, 0x02, 0x7f, 0x00,
    # Query Length (little-endian)
    0x0a, 0x00,
    # ANQP Query List: id=256, len=6, requested-ids...
    0x00, 0x01, 0x06, 0x00,
    0x01, 0x01,      # 257 Venue Name
    0x02, 0x01,      # 258 Network Auth Type
    0x03, 0x01,      # 259 Roaming Consortium
    0x05, 0x01,      # 261 NAI Realm
    0x09, 0x01,      # 265 Domain Name
])
...
- **Venue Name (257)** — WCTF puzzle: "the venue name is the flag."
- **NAI Realm (261)** — "the realm string is the flag."
- **Domain Name (265)** — "the domain string is the flag."
- **Roaming Consortium (259)** — "the OI is the flag."
